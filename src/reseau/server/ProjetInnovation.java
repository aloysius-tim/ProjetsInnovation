...
import reseau.common.IProjetInnovation;
...
public class ProjetInnovation implements IProjetInnovation {
    ...
    public ProjetInnovation() {
        ...
        Student s2 = new Student("Nikita", "nikita@rousseau.fr");
        Student s3 = new Student("Tim2", "Nikita2@rousseau.fr");
        Student s4 = new Student("Nikita2", "tim2@keynes.fr");
